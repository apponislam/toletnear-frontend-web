            ...
            {tabs.map((t) => (
                <button
                    ...
                    style={{
                        ...
                        borderRadius: 7,
                        border: "none",
                        backgroundColor: active === t ? "#fff" : "transparent",
                        color: active === t ? "#1A4F9E" : "#6B7280",
                        cursor: "pointer",
    ...
    return (
        <div style={{ backgroundColor: "#fff", borderRadius: 14, padding: "20px", border: "1px solid #E2E8F0", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                ...
                <div style={{ width: 46, height: 46, borderRadius: 12, backgroundColor: color, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, color: textColor }}>{icon}</div>
            </div>
        </div>
    );
}
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "32px 24px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 26 }}>
                ...
                <Link href="/post-property" style={{ textDecoration: "none" }}>
                    <button style={{ padding: "10px 20px", borderRadius: 9, border: "none", backgroundColor: "#0DB678", color: "#fff", cursor: "pointer", fontWeight: 700, fontSize: 14, display: "flex", alignItems: "center", gap: 6 }}>+ Add Property</button>
                </Link>
            </div>
                    ...
                    <div style={{ backgroundColor: "#fff", borderRadius: 12, border: "1px solid #E2E8F0", overflow: "hidden" }}>
                        ...
                        {inquiries.map((inq, i) => (
                            <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 20px", borderBottom: i < 3 ? "1px solid #F1F5F9" : "none" }}>
                                <div style={{ width: 38, height: 38, borderRadius: "50%", backgroundColor: "#EBF2FF", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Outfit, sans-serif", fontWeight: 700, color: "#1A4F9E", fontSize: 15, flexShrink: 0 }}>
                                    {inq.name.charAt(0)}
                                </div>
                                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ backgroundColor: "#fff", borderRadius: 12, border: "1px solid #E2E8F0", overflow: "hidden" }}>
                        ...
                        {[
                            ...
                            <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 20px", borderBottom: i < 3 ? "1px solid #F1F5F9" : "none" }}>
                                <div style={{ width: 36, height: 36, borderRadius: "50%", backgroundColor: "#EBF2FF", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Outfit, sans-serif", fontWeight: 700, color: "#1A4F9E", fontSize: 14, flexShrink: 0 }}>
                                    {u.name.charAt(0)}
                                </div>
                                <div style={{ flex: 1 }}>
                ...
                <div style={{ backgroundColor: "#fff", borderRadius: 12, border: "1px solid #E2E8F0", overflow: "hidden" }}>
                    ...
                    {[
                        ...
                        <div key={i} style={{ display: "flex", alignItems: "center", gap: 14, padding: "14px 20px", borderBottom: i < 3 ? "1px solid #F1F5F9" : "none" }}>
                            <div style={{ width: 38, height: 38, borderRadius: "50%", backgroundColor: "#EBF2FF", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Outfit, sans-serif", fontWeight: 700, color: "#1A4F9E", fontSize: 14, flexShrink: 0 }}>
                                {u.name.charAt(0)}
                            </div>
                            <div style={{ flex: 1 }}>
                            ...
                            <div style={{ display: "flex", gap: 5 }}>
                                ...
                                <button style={{ padding: "6px 12px", borderRadius: 7, border: "none", backgroundColor: u.status === "Active" ? "#FEE2E2" : "#DCFCE7", color: u.status === "Active" ? "#DC2626" : "#16A34A", cursor: "pointer", fontSize: 12 }}>
